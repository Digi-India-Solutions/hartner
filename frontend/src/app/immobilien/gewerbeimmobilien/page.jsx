...
<h1 className="text-4xl md:text-6xl font-serif mt-4 leading-tight text-black">
  Moderne Gewerbeimmobilien für Unternehmen und Investoren
</h1>

<p className="text-gray-600 mt-6 max-w-3xl text-lg leading-8">
  Von Büroflächen über Geschäftslokale bis hin zu modernen
  Gewerbeobjekten bieten wir individuelle Lösungen für
  Unternehmen, Investoren und Gewerbetreibende.
</p>
      </div>
...
<p className="text-gray-600 text-lg leading-10">
  Diese moderne Gewerbeimmobilie bietet flexible
  Nutzungsmöglichkeiten für Unternehmen, Büros
  und Dienstleister.
</p>

<p className="text-gray-600 text-lg leading-10 mt-6">
  Die Immobilie überzeugt durch ihre zentrale Lage,
  moderne Ausstattung und großzügige Gewerbeflächen.
</p>

<ul className="mt-8 space-y-4 text-gray-600 text-lg">
  <li>• Flexible Büroflächen</li>
  <li>• Moderne Geschäftsräume</li>
  <li>• Gute Verkehrsanbindung</li>
  <li>• Parkmöglichkeiten vorhanden</li>
  <li>• Repräsentativer Eingangsbereich</li>
</ul>
  </div>
